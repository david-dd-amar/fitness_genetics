...
covs_file = "/oak/stanford/groups/euan/projects/fitness_genetics/analysis/mega_with_genepool/eu_gwas/all_covs_and_pheno.phe"
...
# ############################################################################
# ############################################################################
# # Older analysis in which we create the phe files and then run
