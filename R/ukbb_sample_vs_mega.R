...
####################################################################################################
####################################################################################################
# Repeat the process above after selection of EUs
ld_prune_res = paste(bfiles,"ld_prune/",sep="")
system(paste("mkdir",ld_prune_res))
...
cohorts_all[rownames(d)[d$Cohort=="1"]] = "Cooper"
cohorts_all[rownames(d)[d$Cohort=="2"]] = "ELITE"
cohorts_all[rownames(d)[d$Cohort=="genepool"]] = "GP"
table(cohorts_all)
